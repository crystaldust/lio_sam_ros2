...
public:
    ImageProjection(const rclcpp::NodeOptions & options) : ParamServer("lio_sam_ros2_imageProjection", options)//, deskewFlag(0)
    {
        ...
        subOdom = create_subscription<nav_msgs::msg::Odometry>(odomTopic + "_incremental", 2000, odom_callback);
        ...
        pubExtractedCloud = create_publisher<sensor_msgs::msg::PointCloud2>("lio_sam_ros2/deskew/cloud_deskewed", 1);
        pubLaserCloudInfo = create_publisher<lio_sam_ros2::msg::CloudInfo>("lio_sam_ros2/deskew/cloud_info", 1);
        allocateMemory();
        resetParameters();
    ...
    bool deskewInfo()
    {
        ...
        if (imuQueue.empty() || t_f > timeScanCur || t_b < timeScanEnd)
        {
